...
{green}[<ID~>github] ▪︎  {white}https://https://github.com/M-D-ABID1015
{cyan}[<ID~>telegram] ▪︎  {white}@DARK NET HACKE BOYS
{magenta}[<ID~>instagram] ▪︎  {white}@abid7_578
